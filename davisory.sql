...
CREATE TABLE Fornecedor (
    ...
    fk_Endereco_id VARCHAR(50) NOT NULL,
    FOREIGN KEY (fk_Endereco_id) REFERENCES Endereco(idEndereco)
);

CREATE TABLE MateriaPrima (
    idMateriaPrima VARCHAR(50) PRIMARY KEY,
...
CREATE TABLE Produto (
    idProduto VARCHAR(50) PRIMARY KEY,
...
CREATE TABLE EstoqueProduto (
    idEstoqueProduto VARCHAR(50),
    fk_Produto_idProduto VARCHAR(50),
...
CREATE TABLE Cliente (
    ...
    fk_Endereco_idEndereco VARCHAR(50) NOT NULL,
...
CREATE TABLE Pedido (
    ...
    fk_Produto_idProduto VARCHAR(50) NOT NULL,
    fk_Funcionario_idFuncionario VARCHAR(50) NOT NULL,
...
CREATE TABLE Atende (
    ...
    fk_Administrativo_Funcionario_idFuncionario VARCHAR(50),
    dataAtendimento DATE NOT NULL DEFAULT CURRENT_DATE,
...
CREATE TABLE EstoqueMateriaPrima (
    idEstoqueMateriaPrima VARCHAR(50),
    fk_MateriaPrima_idMateriaPrima VARCHAR(50),
    quantidadeMateriaPrima INTEGER NOT NULL CHECK (quantidadeMateriaPrima >= 0),
...
CREATE TABLE Monta (
    fk_Operacional_Funcionario_idFuncionario VARCHAR(50),
    fk_Pedido_idPedido VARCHAR(50),
